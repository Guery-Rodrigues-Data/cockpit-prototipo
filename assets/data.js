...
const ALERTAS = [
  ...
  // Fixos no 112962 (controlador real, vem do Supabase) pra ter sempre alerta pra olhar
  // enquanto mexemos na aba Alertas — descrição e tipo batem com ALARMES_CATALOGO (assets/alarmes.js).
  { id: "ALR-9013", equipamentoId: "112962", tipoAlarme: "comunicacao", descricao: "Falha na comunicação com o dispositivo", severidade: "Alto", dataHora: "22/09/2026 09:40" },
